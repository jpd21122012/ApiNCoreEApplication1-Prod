...
namespace ApiNCoreEApplication1.Api.Controllers
{
    ...
    [ApiController]
    public class PlayerStatsController : ControllerBase, IDBAbstraction<PlayerStatsViewModel>
    {
        private readonly PlayerStatsService<PlayerStatsViewModel, PlayerStat> _playerStatsService;
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public ActionResult<object> Select()
        {
            try
            {
                ...
                var test = _playerStatsService.DoNothing();
                var items = _playerStatsService.GetAll();
        ...
        public ActionResult<object> SelectById(int id)
        {
            try
            {
                var item = _playerStatsService.GetOne(id);
                if (item == null)
                {
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
        ...
        public ActionResult<object> Post([FromBody] PlayerStatsViewModel user)
        {
            ...
            else
            {
                try
                {
                    var id = _playerStatsService.Add(user);
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
                        Status = 200,
                        Data = null
        ...
        [Authorize(Roles = "Administrator")]
        [HttpPut("{id}")]
        public ActionResult<object> Put(int id, [FromBody] PlayerStatsViewModel user)
        {
            ...
            else
            {
                try
                {
                    int retVal = _playerStatsService.Update(user);
        ...
        public ActionResult<object> Delete(int id)
        {
            try
            {
                ...
                int retVal = _playerStatsService.Remove(id);
                if (retVal >= 0)
                {
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
