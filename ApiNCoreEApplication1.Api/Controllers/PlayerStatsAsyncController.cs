...
{
    /// <summary>
    /// PlayerStats Async Controller
    /// </summary>
    [ApiVersion("1.0")]
    [Route("api/[controller]")]
    //[Route("api/v{version:apiVersion}/[controller]")]
    [ApiController]
    public class PlayerStatsAsyncController : ControllerBase
    {
        private readonly PlayerStatsServiceAsync<PlayerStatsViewModel, PlayerStat> _playerStatsServiceAsync;
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="playerStatsServiceAsync"></param>
        public PlayerStatsAsyncController(PlayerStatsServiceAsync<PlayerStatsViewModel, PlayerStat> playerStatsServiceAsync)
        {
            _playerStatsServiceAsync = playerStatsServiceAsync;
        }


        /// <summary>
        /// Returns all PlayerStats.
        /// </summary>
        ...
        public async Task<ActionResult<object>> SelectAsync()
        {
            try
            {
                var items = await _playerStatsServiceAsync.GetAll();
                if (items.ToList().Count > 0)
                {
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
                        Status = 200,
                        Data = new List<PlayerStatsViewModel>(items)
                    };
        ...
        // GET api/table/5
        /// <summary>
        /// Returns an specific PlayerStats.
        /// </summary>
        /// <param name="id"></param>
        /// <response code="200">Returns the newly created item</response>
        /// <response code="401">No Authorized</response>
        ...
        public async Task<ActionResult<object>> SelectByIdAsync(int id)
        {
            try
            {
                var item = await _playerStatsServiceAsync.GetOne(id);
                if (item == null)
                {
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
                ...
                else
                {
                    ...
                    {
                        Status = 200,
                        Data = new List<PlayerStatsViewModel> { item }
                    };
                    return JsonConvert.SerializeObject(toSerialize);
                }
            }
        ...
        // POST api/table
        /// <summary>
        /// Creates an specific PlayerStats.
        /// </summary>
        ...
        /// <summary>
        /// Updates an specific PlayerStats.
        /// </summary>
        /// <param name="user"></param>
        /// <param name="id"></param>
        /// <response code="200">Returns the newly created item</response>
        ...
        /// <summary>
        /// Deletes a specific PlayerStats.
        /// </summary>
        /// <param name="id"></param>
        /// <response code="200">Returns the newly created item</response>
        /// <response code="401">No Authorized</response>
        ...
        public async Task<ActionResult<object>> DeleteAsync(int id)
        {
            try
            {
                ...
                int retVal = await _playerStatsServiceAsync.Remove(id);
                if (retVal >= 0)
                {
                    var toSerialize = new MessageHelpers<PlayerStatsViewModel>()
                    {
